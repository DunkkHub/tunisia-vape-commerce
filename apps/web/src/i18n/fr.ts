  ...
  translation: {
    ...
    admin: {
      ...
      deliveryOps: {
        ...
        courier: 'Livreur',
        manage: 'Gérer',
        manageDeliveryAria: 'Gérer la livraison {{id}}',
        selectDelivery: 'Sélectionner {{id}} pour un manifeste',
        manifestRequiresAssignment: 'Assignez-la d’abord à un livreur.',
        manifestPermissionRequired: 'Permission requise pour le manifeste.',
